  ...
  try {
    ...
    if (isPasswordMatch) {
      ...
      var mailOptions = {
        ...
        to: email,
        subject: 'Connection détectée sur votre compte BookBrawl',
        html: `
                  <!DOCTYPE html>
...
<head>
  ...
  <title>Connexion détectée</title>
  <style>
    img {
...
<body>
  ...
  <!--[if !gte mso 9]><!----><span class="mcnPreviewText"
    style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Quelqu'un
    s'est connecté avec votre adresse mail</span><!--<![endif]-->
  <!---->
  <center>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td
                                                    ...
                                                    class="mceBlockContainer" align="center" valign="top"><span
                                                      class="mceImageBorder"
                                                      style="border:0;vertical-align:top;margin:0"><img
                                                        data-block-id="2" width="660" height="auto"
                                                        style="width:660px;height:auto;max-width:660px !important;display:block"
                                                        alt=""
                                                        src="https://res.cloudinary.com/dpqhhckyj/image/upload/v1721645782/bandeau_mclz8z.jpg"
                                                        role="presentation" class="imageDropZone mceImage"></span></td>
                                                </tr>
                                                <tr>
                                                  <td
                                                    style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0"
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td
                                                            ...
                                                            <div data-block-id="11" class="mceText" id="dataBlockId-11"
                                                              style="width:100%">
                                                              <h1 class="last-child"><span
                                                                  style="color:#79313c;">Nouvelle connexion
                                                                  détectée</span></h1>
                                                            </div>
                                                          </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                          <td
                                                            ...
                                                            <div data-block-id="3" class="mceText" id="dataBlockId-3"
                                                              style="width:100%">
                                                              <p class="last-child">Hello ${prenom} !<br>Nous t’informons d’une
                                                                connexion sur le site <a
                                                                  href="https://book-brawl.vercel.app" target="_blank"
                                                                  style="color: #3c1a23;"><span
                                                                    style="text-decoration:underline;">BookBrawl -
                                                                    Website</span></a> avec cette adresse mail ${EmailAdress}. N’oublie pas de rentrer
                                                                tes livres régulièrement !</p>
                                                            </div>
                                                          </td>
                                                        </tr>
                                                      </tbody>
                                                ...
                                                <tr>
                                                  <td
                                                    style="padding-top:12px;padding-bottom:12px;padding-right:24px;padding-left:24px"
                                                    class="mceBlockContainer" align="center" valign="top">
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                      role="presentation" data-block-id="18" class="mceButtonContainer">
                                                      <tbody>
                                                        <tr><!--[if !mso]><!--></tr>
                                                        <tr class="mceStandardButton">
                                                          <td
                                                            ...
                                                            class="mceButton" valign="top"><a
                                                              href="https://book-brawl.vercel.app" target="_blank"
                                                              class="mceButtonLink"
                                                              style="background-color:#ffe5d9;border-radius:0;border:1px solid #ffdbd8;color:#79313c;display:block;font-family:'Helvetica Neue', Helvetica, Arial, Verdana, sans-serif;font-size:16px;font-weight:bold;font-style:normal;padding:16px 28px;text-decoration:none;min-width:30px;text-align:center;direction:ltr;letter-spacing:0px">BookBrawl
                                                              - Website</a></td>
                                                        </tr>
                                                        <tr><!--<![endif]--></tr>
                                                        <tr>
    ...
    href="https://book-brawl.vercel.app"
    style="v-text-anchor:middle; width:216.45000000000002px; height:52px;"
    arcsize="0%"
    strokecolor="#ffdbd8"
    strokeweight="1px"
    fillcolor="#ffe5d9">
                                                        ...
                                                        <tr>
                                                          <td
                                                            ...
                                                            <div data-block-id="13" class="mceText" id="dataBlockId-13"
                                                              style="width:100%">
                                                              <p class="last-child">Ce n’est pas toi ? Contacte nous à
                                                                l’adresse mail
                                                                <strong>bookbrawl.contact@gmail.com</strong> ou
                                                                <strong>répond</strong> à cet email.
                                                              </p>
                                                            </div>
                                                          </td>
                                                        </tr>
                                                  ...
                                                  <td
                                                    ...
                                                    <table width="100%" style="border:0;border-collapse:separate">
                                                      <tbody>
                                                        <tr>
                                                          <td
                                                            style="padding-left:24px;padding-right:24px;padding-top:4px;padding-bottom:5px"
                                                            class="mceTextBlockContainer">
                                                            <div data-block-id="12" class="mceText" id="dataBlockId-12"
                                                              style="width:100%">
                                                              <p class="last-child"><strong><span
                                                                    style="color:#79313c;"><span
                                                                      style="font-size: 23px">Bonne lecture
                                                                      !</span></span></strong><br>L’équipe Bookbrawl</p>
                                                            </div>
                                                          </td>
                                                        </tr>
                                                      </tbody>
                                                  ...
                                                  <td
                                                    ...
                                                    <table width="100%" style="border:0;border-collapse:separate">
                                                      <tbody>
                                                        <tr>
                                                          <td
                                                            style="padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:0"
                                                            class="mceTextBlockContainer">
                                                            <div data-block-id="16" class="mceText" id="dataBlockId-16"
                                                              style="width:100%">
                                                              <p class="last-child"><span style="color:#9d8189;"><span
                                                                    style="font-size: 14px">Une question ? Contacte nous
                                                                    à </span></span><strong><span
                                                                    style="color:#9d8189;"><span
                                                                      style="font-size: 14px">bookbrawl.contact@gmail.com</span></span></strong><span
                                                                  style="color:#9d8189;"><span
                                                                    style="font-size: 14px"> OU </span></span><strong><span
                                                                    style="color:#9d8189;"><span
                                                                      style="font-size: 14px">répond</span></span></strong><span
                                                                  style="color:#9d8189;"><span
                                                  ...
                                                  <td
                                                    ...
                                                    <table width="100%" style="border:0;border-collapse:separate">
                                                      <tbody>
                                                        <tr>
                                                          <td
                                                            style="padding-left:24px;padding-right:24px;padding-top:0;padding-bottom:8px"
                                                            class="mceTextBlockContainer">
                                                            <div data-block-id="17" class="mceText" id="dataBlockId-17"
                                                              style="width:100%">
                                                              <p style="display: flex; justify-content: center; align-items: center;"
                                                                class="last-child"><span style="color:#9d8189;"><span
                                                                  ...
                                                                  target="_blank"
                                                                  style="color: #9d8189; display: flex; align-items: center; justify-content: center;"><img
                                                                    src="https://res.cloudinary.com/dpqhhckyj/image/upload/v1721648915/whatsapp_xjlo0b.png"
                                                                    width="30" height="auto" alt=""></a>
                                                              </p>
                                                            </div>
                                                          </td>
                                                        </tr>
                                                ...
                                                <tr>
                                                  <td
                                                    ...
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                      ...
                                                      id="section_17c88428bc999e89af95f7fe8fe818eb"
                                                                                  ...
                                                                                  <td
                                                                                    ...
                                                                                    <div data-block-id="5"
                                                                                      ...
                                                                                      <p class="last-child"><a
                                                                                          href="https://mailchi.mp/a355d0adb737/connexion-dtecte?e=[UNIQID]"><span
                                                                                          ...
                                                                                          href="https://app.us17.list-manage.com/profile?u=d82671e0cb0299b9581802a77&id=a6398fea74&e=[UNIQID]&c=cade5172ce"><span
                                                                                            style="font-size: 11px">update
                                                                                            your
                                                                                            preferences</span></a><span
                                                                                          style="font-size: 11px"> or
                                                                                        </span><a
                                                                                          href="https://app.us17.list-manage.com/unsubscribe?u=d82671e0cb0299b9581802a77&id=a6398fea74&t=b&e=[UNIQID]&c=cade5172ce"><span
                                                          ...
                                                          <td
                                                            ...
                                                            <div data-block-id="3" class="mceText" id="dataBlockId-3"
                                                              ...
                                                              <p style="text-align: left;"><span
                                                                  style="color:#4d222e;">Hello ${nom} !</span></p>
                                                    ...
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr class="mceStandardButton">
                                                          <td
                                                            style="background-color:#ffe5d9;border-radius:0;text-align:center"
                                                            class="mceButton" valign="top"><a href="${resetPasswordLink}" target="_blank"
                                                              class="mceButtonLink"
                                                            ...
                                                            <div data-block-id="25" class="mceText" id="dataBlockId-25"
                                                              ...
                                                              <p style="display: flex; justify-content: center; align-items: center;"
                                                                class="last-child"><span style="color:#9d8189;"><span
                                                                    ...
                                                                    WhatsApp : &nbsp;&nbsp;&nbsp;</span></span><a
                                                                  href="https://chat.whatsapp.com/CQNSY4nA3OO3ycC0S2hDuj"
                                                                  target="_blank" style="color: #9d8189; display: flex; align-items: center; justify-content: center;"><img
                                                                    src="https://res.cloudinary.com/dpqhhckyj/image/upload/v1721648915/whatsapp_xjlo0b.png"
                                                                    width="30" height="auto" alt=""></a>
                                                              </p>
                                                            </div>
